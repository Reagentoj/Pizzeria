package ru.pizza.strings;

/**
 * Класс для хранения строковых и числовых данных
 */
public class StringsSource {

    /** Названия пицц */
    public static final String pizzaMargarita = "Маргарита";
    public static final String pizzaPepperoni = "Пепперони";
    public static final String pizzaFourCheese = "Четыре сыра";
    public static final String pizzaMushroom = "Грибная";
    public static final String pizzaCarbonara = "Карбонара";

    /** Цены на пиццы */
    public static final double costMargarita = 5.00;
    public static final double costPepperoni = 6.25;
    public static final double costFourCheese = 6.20;
    ...
    public static final String ingredientCapers = "Каперсы";
    ...
    public static final double ingredientCapersCost = 2.50;
    ...
    public static final long sellerAlexId = 1020;
    public static final String sellerAlexName = "Александр Дуб";
    public static final int sellerAlexAge = 21;
}
